...
print('{tag}\n\n{cmd}\n\n{tag}'.format(tag='#'*30, cmd=cmd_resnet50))
os.system(cmd_resnet50)
print('{tag}\n\n{cmd}\n\n{tag}'.format(tag='#'*30, cmd='END Eval resnet50'))

print('{tag}\n\n{cmd}\n\n{tag}'.format(tag='#'*30, cmd=cmd_resnet101))
os.system(cmd_resnet101)
print('{tag}\n\n{cmd}\n\n{tag}'.format(tag='#'*30, cmd='END Eval resnet101'))
